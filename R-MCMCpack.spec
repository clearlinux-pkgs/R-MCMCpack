...
Version  : 1.6.1
Release  : 48
URL      : https://cran.r-project.org/src/contrib/MCMCpack_1.6-1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/MCMCpack_1.6-1.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1646333734
