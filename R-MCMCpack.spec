...
Version  : 1.4.2
Release  : 1
URL      : https://cran.r-project.org/src/contrib/MCMCpack_1.4-2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/MCMCpack_1.4-2.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1523745578
