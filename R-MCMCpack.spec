...
Version  : 1.4.3
Release  : 10
URL      : https://cran.r-project.org/src/contrib/MCMCpack_1.4-3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/MCMCpack_1.4-3.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1526528356
